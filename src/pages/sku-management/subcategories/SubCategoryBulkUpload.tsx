...
import { addBulkSubcategories } from "../../../services/ApiService";

interface SubCategoryBulkUploadProps {
    isOpen: boolean;
    onClose: () => void;
    onUpload: () => void;
}

const SubCategoryBulkUpload: React.FC<SubCategoryBulkUploadProps> = ({ isOpen, onClose, onUpload }) => {
    ...
    const handleDownloadSample = () => {
        ...
        XLSX.writeFile(workbook, "Subcategory_Bulk_Upload_Sample.xlsx");
    };
    ...
    const handleSubmit = async () => {
        setIsProcessing(true);
        try {
            const res = await addBulkSubcategories(excelData);
            const body = res.data;
            ...
            toast.success(body?.message || "Subcategories processed");
        } catch (error: any) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl shadow-2xl max-w-5xl w-full mx-4 max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="px-6 py-4 border-b bg-blue-50 flex justify-between items-center">
                    <div>
                        <h2 className="text-xl font-bold text-blue-700">Bulk Upload Subcategories</h2>
...
export default SubCategoryBulkUpload;
