...
import { BlockedMemberScanReportKeys } from "../../../../utils/ExportKeyMappings";


const BlockedMemberQrScanReport = () => {
    ...
    return (
        <div className="bg-white rounded-xl shadow p-5 border border-gray-200 w-full overflow-x-hidden">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div>
                    <h2 className="text-xl font-bold">Blocked Member QR Scan Report</h2>
                    <p className="text-gray-500 text-sm">QR scans performed by blocked members</p>
                </div>
...
export default BlockedMemberQrScanReport;
